...
@SuppressLint("UnsafeOptInUsageError")
 public class WebTapTap extends GestureDetector.SimpleOnGestureListener {
    ...
    public boolean onSingleTapConfirmed(@NonNull MotionEvent event) {
        if (onlinePlayerControlLayout.getVisibility() == View.VISIBLE){
            onlinePlayerControlLayout.setVisibility(View.GONE);
        }else{
            onlinePlayerControlLayout.setVisibility(View.VISIBLE);
            MyHandler.hideControls(onlinePlayerControlLayout);
        }
