...
public class OnlinePlayerViewBackUp implements View.OnClickListener {
...
//    public OnlinePlayerViewBackUp(Context context, ConstraintLayout playerLayout) {
...
//            screen(true);
//            PlayerActivity.listener.onShow(true);
...
//            screen(false);
//            PlayerActivity.listener.onShow(false);
