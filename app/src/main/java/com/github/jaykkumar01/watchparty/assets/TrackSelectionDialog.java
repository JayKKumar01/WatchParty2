 ...
 */
package com.github.jaykkumar01.watchparty.assets;
...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  private static class DialogHeight {
    public static void set(ViewPager viewPager) {
      ...
      if (Resources.getSystem().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE){
        lp.height = (int) (Resources.getSystem().getDisplayMetrics().heightPixels * .7);
      }else {
        lp.height = (int)(Resources.getSystem().getDisplayMetrics().heightPixels * .3);
      }
